...
REM Open the first URL in Chrome's default profile
start chrome "http://192.168.1.161/html/remote.html"

REM Open the second URL in Chrome's default profile
start chrome "http://192.168.1.162/html/remote.html"
...
:echo Would you like to exit Chrome?
echo (Y = Yes, N = No)
choice /C YN /N
